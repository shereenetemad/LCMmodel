...
!(function (t, n) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define(n)
    : ((t = "undefined" != typeof globalThis ? globalThis : t || self).io = n());
})(this, function () {
  "use strict";
  function t(t, n) {
  ...
  function s(t, n) {
    (t.prototype = Object.create(n.prototype)), (t.prototype.constructor = t), h(t, n);
  }
  function u() {
    try {
    ...
    return new TransformStream({
      transform: function (t, n) {
        !(function (t, n) {
          ...
          var r,
            e = i.length;
          if (e < 126) (r = new Uint8Array(1)), new DataView(r.buffer).setUint8(0, e);
          else if (e < 65536) {
            r = new Uint8Array(3);
  ...
  (I.prototype.on = I.prototype.addEventListener =
    function (t, n) {
      return (
        (this.t = this.t || {}), (this.t["$" + t] = this.t["$" + t] || []).push(n), this
      );
    }),
  ...
  function F() {
    return (
      Date.now().toString(36).substring(3) + Math.random().toString(36).substring(2, 5)
    );
  }
  var V = (function (t) {
      function n(n, i, r) {
    ...
    q = (function (t) {
      ...
      return (
        (i.onError = function (n, i, r) {
          return t.prototype.emitReserved.call(this, "error", new V(n, i, r)), this;
        }),
        (i.open = function () {
        ...
        (i.onClose = function (n) {
          (this.readyState = "closed"), t.prototype.emitReserved.call(this, "close", n);
        }),
        (i.pause = function (t) {}),
      ...
      return (
        ...
        (r.onData = function (t) {
          ...
          (function (t, n) {
            ...
            if (
              ...
              return n.onClose({ description: "transport closed by the server" }), !1;
            n.onPacket(t);
          }),
        ...
        (r.uri = function () {
          var t = this.opts.secure ? "https" : "http",
            n = this.query || {};
          return (
            !1 !== this.opts.timestampRequests && (n[this.opts.timestampParam] = F()),
  ...
  var K = (function (t) {
      function n(n) {
        ...
        if (((i = t.call(this, n) || this), "undefined" != typeof location)) {
          ...
          e || (e = r ? "443" : "80"),
            (i.xd =
              ("undefined" != typeof location && n.hostname !== location.hostname) ||
              e !== n.port);
        }
        return i;
      }
      ...
      return (
        (i.A = function () {
          ...
          try {
            ...
            null === (t = this.l.cookieJar) || void 0 === t || t.addCookies(e),
              "withCredentials" in e && (e.withCredentials = this.l.withCredentials),
        ...
        (i.N = function (t) {
          if (void 0 !== this.j && null !== this.j) {
            ...
            "undefined" != typeof document && delete n.requests[this.S], (this.j = null);
          }
        }),
        (i.O = function () {
          var t = this.j.responseText;
          null !== t &&
            (this.emitReserved("data", t), this.emitReserved("success"), this.N());
        }),
        (i.abort = function () {
          this.N();
        }),
  ...
  if (((Y.requestsCount = 0), (Y.requests = {}), "undefined" != typeof document))
  ...
  function tt(t) {
    var n = t.xdomain;
    try {
      if ("undefined" != typeof XMLHttpRequest && (!n || z)) return new XMLHttpRequest();
    } catch (t) {}
    if (!n)
      try {
                      ...
                      transform: function (s, u) {
                        for (i.push(s); ; ) {
                          if (0 === r) {
                            ...
                            if (M(i) < 2) break;
                            var f = x(i, 2);
                            (e = new DataView(f.buffer, f.byteOffset, f.length).getUint16(
                              0
                            )),
                              (r = 3);
                          } else if (2 === r) {
                            if (M(i) < 8) break;
                            var c = x(i, 8),
                              a = new DataView(c.buffer, c.byteOffset, c.length),
                              v = a.getUint32(0);
  ...
  function ft(t) {
    ...
    for (var e, o, s = ut.exec(t || ""), u = {}, h = 14; h--; ) u[ht[h]] = s[h] || "";
    return (
      -1 != i &&
        -1 != r &&
        ((u.source = n),
  ...
  var ct =
      "function" == typeof addEventListener && "function" == typeof removeEventListener,
    at = [];
  ct &&
    addEventListener(
      "offline",
  ...
  var vt = (function (t) {
    function n(n, i) {
      ...
      return (
        ...
        (r.opts.path =
          r.opts.path.replace(/\/$/, "") + (r.opts.addTrailingSlash ? "/" : "")),
        "string" == typeof r.opts.query &&
          (r.opts.query = (function (t) {
            for (var n = {}, i = t.split("&"), r = 0, e = i.length; r < e; r++) {
              var o = i[r].split("=");
        ...
        ct &&
          ...
          "localhost" !== r.hostname &&
            ((r.$ = function () {
              r.F("transport close", { description: "network connection lost" });
            }),
            at.push(r.$))),
    ...
    return (
      ...
      (i.flush = function () {
        if (
          ...
          var t = this.G();
          this.transport.send(t), (this.M = t.length), this.emitReserved("flush");
        }
      }),
      (i.G = function () {
      ...
      (i.F = function (t, n) {
        if (
          ...
          if (
            ...
            ct && (this.P && removeEventListener("beforeunload", this.P, !1), this.$))
          ) {
              ...
              i.once("packet", function (t) {
                if (!r)
                  if ("pong" === t.type && "probe" === t.data) {
                    if (((n.upgrading = !0), n.emitReserved("upgrading", i), !i)) return;
    ...
    pt = (function (t) {
      function n(n) {
        var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
          r = "object" === c(n) ? n : i;
        return (
          (!r.transports || (r.transports && "string" == typeof r.transports[0])) &&
  ...
  var dt = "function" == typeof ArrayBuffer,
    ...
    wt =
      "function" == typeof Blob ||
      ("undefined" != typeof Blob && "[object BlobConstructor]" === bt.call(Blob)),
    gt =
      "function" == typeof File ||
      ("undefined" != typeof File && "[object FileConstructor]" === bt.call(File));
  function mt(t) {
    return (
  ...
  function At(t) {
    var n = [],
      i = t.data,
      r = t;
    return (r.data = jt(i, n)), (r.attachments = n.length), { packet: r, buffers: n };
  }
  function jt(t, n) {
    if (!t) return t;
    if (mt(t)) {
    ...
    if (Array.isArray(t)) {
      for (var r = new Array(t.length), e = 0; e < t.length; e++) r[e] = jt(t[e], n);
      return r;
    }
    if ("object" === c(t) && !(t instanceof Date)) {
      var o = {};
      for (var s in t) Object.prototype.hasOwnProperty.call(t, s) && (o[s] = jt(t[s], n));
      return o;
    }
    return t;
  }
  ...
  function Ot(t, n) {
    ...
    if (Array.isArray(t)) for (var i = 0; i < t.length; i++) t[i] = Ot(t[i], n);
      ...
      for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (t[r] = Ot(t[r], n));
    return t;
  }
  var Bt,
    St = [
          ...
          if ("string" == typeof n) {
            ...
            r || i.type === Bt.BINARY_ACK
              ? ((i.type = r ? Bt.EVENT : Bt.ACK),
                ...
                0 === i.attachments && t.prototype.emitReserved.call(this, "decoded", i))
      ...
      return (
        ...
        (o.emit = function (t) {
          ...
          var c =
              null ===
                (i =
                  null === (n = this.io.engine) || void 0 === n ? void 0 : n.transport) ||
              void 0 === i
                ? void 0
                : i.writable,
            a =
        ...
        (o.ft = function (t, n) {
          var i,
            r = this,
            e = null !== (i = this.flags.timeout) && void 0 !== i ? i : this.l.ackTimeout;
          if (void 0 !== e) {
        ...
        (o.emitWithAck = function (t) {
          for (
            var n = this, i = arguments.length, r = new Array(i > 1 ? i - 1 : 0), e = 1;
            e < i;
            e++
          )
            r[e - 1] = arguments[e];
        ...
        (o.ht = function (t) {
          ...
          t.push(function (t) {
            if (r === i.rt[0]) {
              if (null !== t) r.tryCount > i.l.retries && (i.rt.shift(), n && n(t));
  ...
  var Dt = (function (t) {
      ...
      return (
        ...
        (i.maybeReconnectOnOpen = function () {
          !this.st && this.At && 0 === this.backoff.attempts && this.reconnect();
        }),
        (i.open = function (t) {
          var n = this;
        ...
        (i.Nt = function () {
          (this.skipReconnect = !0), (this.st = !1), this.onclose("forced close");
        }),
        ...
        (i.reconnect = function () {
          ...
          if (this.backoff.attempts >= this.jt)
            this.backoff.reset(), this.emitReserved("reconnect_failed"), (this.st = !1);
          else {
            ...
            var r = this.setTimeoutFn(function () {
              n.skipReconnect ||
                ...
                n.skipReconnect ||
                  n.open(function (i) {
                    i
                      ? ((n.st = !1), n.reconnect(), t.emitReserved("reconnect_error", i))
                      : n.onreconnect();
                  }));
            }, i);
        ...
        (i.onreconnect = function () {
          ...
          (this.st = !1), this.backoff.reset(), this.emitReserved("reconnect", t);
        }),
        n
      );
    })(I),
    ...
    var i,
      r = (function (t) {
        ...
        return (
          ...
          (r.href =
            r.protocol + "://" + e + (i && i.port === r.port ? "" : ":" + r.port)),
          r
        );
