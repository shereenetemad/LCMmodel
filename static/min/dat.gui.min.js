...
!(function (e, t) {
      ...
      S.extend(n, {
        options: function (t) {
          ...
          if (S.isArray(t) || S.isObject(t)) {
            ...
            return (
              n.remove(), f(e, n.object, n.property, { before: i, factoryArgs: [t] })
            );
          }
        },
        name: function (e) {
  ...
  function y(e) {
    function t(t) {
      return (
        t.preventDefault(), (e.width += i - t.clientX), e.onResize(), (i = t.clientX), !1
      );
    }
    function n() {
  ...
  var A = Array.prototype.forEach,
        ...
        conversions: {
          ...
          SIX_CHAR_HEX: {
            read: function (e) {
              ...
              return (
                null !== t && { space: "HEX", hex: parseInt("0x" + t[1].toString(), 0) }
              );
            },
            write: t,
          },
      ...
      },
      {
        ...
        conversions: {
          ...
          RGBA_ARRAY: {
            read: function (e) {
              return (
                4 === e.length && { space: "RGB", r: e[0], g: e[1], b: e[2], a: e[3] }
              );
            },
            write: function (e) {
    ...
    N = {
      ...
      rgb_to_hex: function (e, t, n) {
        ...
        return (
          (o = this.hex_with_component(o, 1, t)), (o = this.hex_with_component(o, 0, n))
        );
      },
      ...
      function t(e, n, o, i, r) {
        ...
        return (
          ...
          X.bind(u.__background, "touchstart", function (e) {
            1 === e.touches.length &&
              (X.bind(window, "touchmove", d), X.bind(window, "touchend", c), d(e));
          }),
      ...
      function t(e, n) {
        ...
        function _(e) {
          ...
          var t = p.__hue_field.getBoundingClientRect(),
            n =
              1 -
              (((e.touches && e.touches[0]) || e).clientY - t.top) / (t.bottom - t.top);
          return (
            n > 1 ? (n = 1) : n < 0 && (n = 0),
            (p.__color.h = 360 * n),
            p.setValue(p.__color.toOriginal()),
            ...
            value: function () {
              ...
              S.extend(this.__field_knob.style, {
                ...
                S.extend(this.__input.style, {
                  ...
                  color: "rgb(" + n + "," + n + "," + n + ")",
                  textShadow:
                    this.__input_textShadow + "rgba(" + o + "," + o + "," + o + ",.7)",
                });
            },
          },
        ]),
    ...
    S.extend(he.prototype, {
      ...
      saveAs: function (e) {
        this.load.remembered ||
          ((this.load.remembered = {}), (this.load.remembered[se] = x(this, !0))),
